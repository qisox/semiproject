...
public class ComAttachment {
	...
	public ComAttachment(int fileNo, String originName, String changeName, String filePath) {
		super();
		this.fileNo = fileNo;
	 ...
	 public ComAttachment(int refBno, int fileNo, String originName, String changeName, String filePath) {
	    super();
	    this.refBno = refBno;
	    this.fileNo = fileNo;
		this.originName = originName;
	...
	public ComAttachment(int fileNo, int refBno, String originName, String changeName, String filePath, Date uploadDate,
